...
(function(window, undefined) {
    ...
    (function(window, undefined) {
            ...
            if (documentIsHTML && !seed) {
                ...
                if ((match = rquickExpr.exec(selector))) {
                    ...
                    if ((m = match[1])) {
                        ...
                        push.apply(results, context.getElementsByTagName(
                            selector));
                        return results;
                        ...
                        push.apply(results, context.getElementsByClassName(
                            m));
                        return results;
                    }
                }
                ...
                if (support.qsa && (!rbuggyQSA || !rbuggyQSA.test(
                    ...
                    if (nodeType === 1 && context.nodeName.toLowerCase() !==
                        ...
                        newContext = rsibling.test(selector) && context
                            .parentNode || context;
        ...
        function addHandle(attrs, handler, test) {
            ...
            while (i--) {
                ...
                if (!(current = Expr.attrHandle[attrs[i]]) || current ===
                    handler) {
	...
	---------------------------------------------------------------------- */
            ...
            support.attributes = assert(function(div) {
                ...
                addHandle("type|href|height|width",
                    interpolationHandler, div.firstChild.getAttribute(
                        "href") === "#");

                // Support: IE<9
                // Use getAttributeNode to fetch booleans when getAttribute lies
                addHandle(booleans, boolHandler, div.getAttribute(
                    "disabled") == null);
                ...
                Expr.filter["ID"] = function(id) {
                    ...
                    return function(elem) {
                        var node = typeof elem.getAttributeNode !==
                            strundefined && elem.getAttributeNode(
                                "id");
	...
	---------------------------------------------------------------------- */
            ...
            support.sortDetached = assert(function(div1) {
                ...
                return div1.compareDocumentPosition(doc.createElement(
                    "div")) & 1;
            });
                            ...
                            if (parent) {
                                ...
                                if (forward && useCache) {
                                    ...
                                    diff = cache[0] === dirruns &&
                                        cache[2];
                                    node = nodeIndex && parent.childNodes[
                                        nodeIndex];
                ...
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        return setMatcher(
                            ...
                            .replace(rtrim, "$1"),
                            matcher,
                            i < j && matcherFromTokens(tokens.slice(
                                i, j)),
    ...
    jQuery.support = (function(support) {
        ...
        jQuery(function() {
            ...
            if (window.getComputedStyle) {
                ...
                marginDiv = div.appendChild(document.createElement(
                    "div"));
    ...
    jQuery.extend({
        ...
        acceptData: function(elem) {
            ...
            if (elem.nodeType && elem.nodeType !== 1 && elem.nodeType !==
                9) {
                return false;
            }
            ...
            var classidValue;
            try {
                classidValue = elem.getAttribute("classid");
            } catch (e) {
                classidValue = elem.classid;
            }
            // nodes accept data unless otherwise specified; rejection can be conditional
            return !noData || noData !== true && classidValue ===
                noData;
        }
    });
            ...
            if (elem) {
                ...
                if (data) {
                    if (!queue || jQuery.isArray(data)) {
                        queue = jQuery._data(elem, type, jQuery.makeArray(
                            data));
                    } else {
                        queue.push(data);
                    }
            ...
            return this.each(function() {
                if (type === "string") {
                    ...
                    while ((className = classNames[i++])) {
                        ...
                        state = isBool ? state : !self.hasClass(
                            className);
    ...
    if (!getSetAttribute) {
        ...
        jQuery.expr.attrHandle.id = jQuery.expr.attrHandle.name = jQuery.expr
            .attrHandle.coords =
            ...
            setup: function() {
                ...
                jQuery.event.add(this, "click._submit keypress._submit",
                    function(e) {
                        ...
                        var elem = e.target,
                            form = jQuery.nodeName(elem, "input") || jQuery
            ...
            postDispatch: function(event) {
                ...
                if (event._submit_bubble) {
                    ...
                    if (this.parentNode && !event.isTrigger) {
                        jQuery.event.simulate("submit", this.parentNode,
                            event, true);
                    }
                }
            },
        ...
        jQuery.event.special.change = {
            ...
            setup: function() {
                ...
                jQuery.event.add(this, "beforeactivate._change", function(e) {
                    ...
                    if (rformElems.test(elem.nodeName) && !jQuery._data(
                        elem, "changeBubbles")) {
            ...
            for (; i < l; i++) {
                ...
                if (elem || elem === 0) {
                    ...
                    if (jQuery.type(elem) === "object") {
                        ...
                        tmp = tmp || safe.appendChild(context.createElement(
                            "div"));
                        ...
                        tmp.innerHTML = wrap[1] + elem.replace(
                            rxhtmlTag, "<$1></$2>") + wrap[2];
                        ...
                        if (!jQuery.support.tbody) {
                            ...
                            while (j--) {
                                if (jQuery.nodeName((tbody = elem.childNodes[
                                        j]), "tbody") && !tbody.childNodes
                                    .length) {
                        ...
                        if (data.events) {
                            for (type in data.events) {
                                if (special[type]) {
                                    ...
                                    jQuery.removeEvent(elem, type, data
                                        .handle);
                                }
                            }
                        }
    ...
    jQuery.fn.extend({
        ...
        wrap: function(html) {
            ...
            return this.each(function(i) {
                jQuery(this)
                    .wrapAll(isFunction ? html.call(this, i) :
                        html);
            });
        },
        ...
        style: function(elem, name, value, extra) {
            ...
            if (value !== undefined) {
                ...
                if (type === "string" && (ret = rrelNum.exec(value))) {
                    value = (ret[1] + 1) * ret[2] + parseFloat(jQuery.css(
                        elem, name));
                    // Fixes bug #9237
                    type = "number";
                }
        ...
        jQuery.expr.filters.hidden = function(elem) {
            ...
            return elem.offsetWidth <= 0 && elem.offsetHeight <= 0 ||
                (!jQuery.support.reliableHiddenOffsets && ((elem.style &&
                    elem.style.display) || jQuery.css(elem,
                    "display")) === "none");
        };
                ...
                return {
                    send: function(headers, complete) {
                        ...
                        callback = function(_, isAbort) {
                            var status, responseHeaders, statusText,
                                responses;
        ...
        var result,
            ...
            tick = function() {
                ...
                var currentTime = fxNow || createFxNow(),
                    remaining = Math.max(0, animation.startTime + animation
        ...
        run: function(percent) {
            ...
            if (this.options.duration) {
                this.pos = eased = jQuery.easing[this.easing](
                    percent, this.options.duration * percent, 0, 1, this.options
                    .duration
                );
            } else {
    ...
    jQuery.each({
        ...
        jQuery.each({
            ...
            jQuery.fn[funcName] = function(margin, value) {
                ...
                return jQuery.access(this, function(elem, type,
                        value) {
                        var doc;
